...
@Service
public class SendNotificationForFormatting implements JavaDelegate {

    private final UserService userService;
    private final MailService mailService;

    public SendNotificationForFormatting(UserService userService, MailService mailService) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        mailService.sendMail(author.getEmail(), "Paper not formatted correctly", message);
    }
}
